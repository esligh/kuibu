...
public class LocalCollectionAdapter extends BaseAdapter{
	...
	boolean isMulChoice ; 
	public LocalCollectionAdapter(Context context,List<CollectionBean> data,boolean isMulChoice)
	{
	...
	public View getView(final int position, View convertView, ViewGroup container) {
		...
		if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.local_collection_list_item, container,false);  
